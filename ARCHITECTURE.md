...
| 11 | **Cantos de pilares em L/U no eixo** (2026-09-26): as lâminas terminam exatamente no cruzamento dos eixos; o trecho além do encontro (só a espessura do canto) é removido, sem toco de parede. O canto passa a contar como ponta da parede na regra da viga; viga cujas pontas estão em linhas diferentes (ex.: ponta de P5 e canto do núcleo P6, 15 cm) tem cada extremidade levada à sua ponta e fica levemente inclinada (INFO ALIGN-I-WALL-END-TILT). Junções em T continuam dividindo a lâmina atravessada. | `column_axes.join_corners`, `alignment._wall_true_ends`, `alignment.snap_beams_to_wall_ends`. |
